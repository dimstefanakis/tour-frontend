import { Paper, Collapse, Text, Button,Container,Center } from "@mantine/core";
  ...
  return (
    ...
    >
      ...
      {CollapsedComponent && (
        ...
        <Button onClick={onClick} style={{minWidth:"100%",height:"100%",color:"black",backgroundColor:"white"}}>▲</Button>
        </Center>
        ) : (
          <Center style={{paddingTop:"10px"}}>
        <Button onClick={onClick} style={{minWidth:"100%",height:"100%",color:"black",backgroundColor:"white"}}>▼</Button>
